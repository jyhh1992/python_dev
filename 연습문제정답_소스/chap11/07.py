...
while True:
    ...
    ## 페이지 업다운 키
    elif key == 0x260000: cnt =  10                # 윗쪽 화살표 키이면 다음 영상
    elif key == 0x280000: cnt = -10                  # 아래쪽 화살표 키이면 이전 영상
    ## 화살표 위아래키
    elif key == 0x210000: cnt =  10                # 윗쪽 화살표 키이면 다음 영상
    elif key == 0x220000: cnt = -10                  # 아래쪽 화살표 키이면 이전 영상
